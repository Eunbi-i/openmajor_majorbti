...
TYPE_INFO = {
    "SAMG": {
        "title": "글로벌 리더형",
        "desc": (
            "사회적 현상을 논리적으로 분석하며, 정책·공공 분야 및 국제 관계를"
            " 다루는 데 강점이 있습니다."
        ),
        "depts": [
            "사회과학대학 정치외교학과",
    ...
    "SAML": {
        "title": "비즈니스 데이터 전략가",
        "desc": (
            "시장과 기업의 데이터를 분석하고 조직의 시스템 및 수치를 효율적으로"
            " 관리합니다."
        ),
        "depts": [
            "경상대학 경영학과",
    ...
    "SARG": {
        "title": "인문학적 사색가",
        "desc": (
            "인간과 사회의 근본적인 사상, 언어, 역사를 논리적·학술적으로 깊이"
            " 탐구합니다."
        ),
        "depts": [
            "인문대학 국어국문학과",
    ...
    "SARL": {
        "title": "글로벌 언어·문화 전문가",
        "desc": (
            "세계 여러 나라의 언어와 문학을 체계적으로 연구하고 글로벌 감각을"
            " 키웁니다."
        ),
        "depts": [
            "인문대학 영어영문학과",
    ...
    "SCMG": {
        "title": "미디어 트렌드 세터",
        "desc": (
            "사회 트렌드와 대중 문화를 재빨리 캐치하여 콘텐츠, 미디어, 관광"
            " 상품을 기획합니다."
        ),
        "depts": [
            "사회과학대학 언론홍보학과",
    ...
    "SCML": {
        "title": "인간 중심 서비스 전문가",
        "desc": (
            "사람들의 삶의 질, 사회적 환경, 라이프스타일을 섬세하게 케어하고"
            " 창의적으로 표현합니다."
        ),
        "depts": [
            "인문대학 사회학과",
    ...
    "SCRG": {
        "title": "공공 경제 전문가",
        "desc": (
            "국가와 시장 전체의 경제 흐름을 독창적으로 분석하고 사회적 자원의"
            " 배분을 연구합니다."
        ),
        "depts": ["사회과학대학 경제학과"],
    },
    "SCRL": {
        "title": "해양 공공 안전 기획자",
        "desc": (
            "바다라는 특수 환경에서 공공의 안전, 법률, 해양 행정 업무를"
            " 창의적·실용적으로 수행합니다."
        ),
    ...
    "TAMG": {
        ...
        "desc": (
            "IT 시스템, 소프트웨어, 통신 및 전자 기술을 바탕으로 디지털 미래를"
            " 설계합니다."
        ),
        "depts": [
            "공과대학 컴퓨터공학과",
    ...
    "TAML": {
        "title": "스마트 에너지·메카 닥터",
        "desc": (
            "기계, 전기, 원자력, 에너지 시스템 등 산업의 핵심 파워를 구축하고"
            " 제어합니다."
        ),
        "depts": [
            "공과대학 전기공학과",
    ...
    "TARG": {
        "title": "기초 수리·물리 탐구자",
        "desc": (
            "우주와 자연계의 근본 법칙을 수학적 논리와 수식으로 파헤치는 수리적"
            " 탐구자입니다."
        ),
    ...
    "TARL": {
        "title": "생명 바이오 연구원",
        "desc": (
            "동식물, 미생물, 유전자 등 모든 생명 현상의 비밀을 밝히고 바이오"
            " 기술을 다룹니다."
        ),
        "depts": [
            "자연과학대학 생물학과",
    ...
    "TCMG": {
        ...
        "desc": (
            "인간이 살아가는 건축물과 도시 공간을 안전하고 아름답게"
            " 기획·설계합니다."
        ),
        "depts": [
            "공과대학 건축공학과",
    ...
    "TCML": {
        "title": "스마트 융합 농업 기획자",
        "desc": (
            "첨단 IT 및 바이오 기술을 농업 및 생명 자원에 창의적으로 결합하여"
            " 미래 먹거리를 창출합니다."
        ),
    ...
    "TCRG": {
        "title": "해양·지구 환경 과학자",
        "desc": (
            "지구와 바다 생태계, 수산 자원 및 환경 오염의 원리를 탐구하고"
            " 생태계를 보존하는 아이디어를 냅니다."
        ),
        "depts": [
            "해양과학대학 해양생명과학과",
    ...
    "TCRL": {
        ...
        "desc": (
            "일상생활과 밀접한 화장품, 식품, 영양 및 화학 물질을 실용적으로"
            " 연구·개발합니다."
        ),
        "depts": [
            "자연과학대학 화학코스메틱학과",
...
questions = [
    {
        "question": (
            "Q1. 뉴스나 유튜브 알고리즘에 주로 떠오르는 관심 영상은?"
        ),
        "options": [
            (
                "요즘 핫한 이슈, 사회적 사건, 사람들의 심리나 문화 트렌드",
                "S",
            ),
            (
                "최신 IT 기기 리뷰, 과학 신기술, 우주/자연 현상의 비밀",
                "T",
            ),
        ],
    },
    {
        ...
        "options": [
            ...
            (
                (
                    "기후 변화, 신종 질병 치료제 개발, 에너지 부족, AI 기술"
                    " 윤리"
                ),
                "T",
            ),
    ...
    {
        "question": (
            "Q3. 학창 시절 상대적으로 흥미를 느꼈던 수업 시간에 가까운 것은?"
        ),
        "options": [
            ("국어, 사회, 역사, 외국어 등 사람과 사회를 배우는 시간", "S"),
            (
                (
                    "수학, 물리학, 화학, 지구과학, 정보 등 원리와 공식을 배우는"
                    " 시간"
                ),
                "T",
            ),
    ...
    {
        "question": (
            "Q4. 영화나 드라마를 볼 때 나도 모르게 더 집중하게 되는 부분은?"
        ),
        "options": [
            ("등장인물 간의 관계, 감정선, 사회적 메시지와 대사", "S"),
            (
                "세계관의 설정, 과학적/기술적 고증, 사건의 논리적 개연성",
                "T",
            ),
        ],
    },
    {
        ...
        "options": [
            (
                "최근 유행하는 밈, 연예/문화 이야기, 서로의 근황과 고민 상담",
                "S",
            ),
            (
                (
                    "게임 메커니즘, 새로 나온 가전/IT 제품, 신기한 과학적"
                    " 퀴즈"
                ),
                "T",
            ),
    ...
    },
    {
        ...
        "options": [
            ...
            (
                (
                    "일단 참신한 아이디어를 빠르게 떠올리고 즉시 시도해 보며"
                    " 수정해 나간다."
                ),
                "C",
            ),
    ...
    {
        "question": (
            "Q7. 내 주장을 다른 사람에게 설득할 때 가장 강력하다고 믿는"
            " 무기는?"
        ),
        "options": [
    ...
    },
    {
        ...
        "options": [
            (
                "개념의 체계와 기본 원리를 뿌리부터 정석대로 이해하는 편이다.",
                "A",
            ),
            (
                "기출문제를 많이 풀면서 실전에 바로 적용하는 방식을 선호한다.",
                "C",
            ),
        ],
    },
    ...
    {
        "question": (
            "Q10. 예상치 못한 문제나 오류에 부딪혔을 때 나의 반응은?"
        ),
        "options": [
            (
                "원인이 무엇인지 순서대로 차근차근 점검하며 논리적으로 풀어간다.",
                "A",
            ),
            (
                "기존 틀을 벗어나 직관적이고 새로운 방식으로 대안을 찾아낸다.",
                "C",
            ),
        ],
    },
    {
        ...
        "options": [
            (
                (
                    "거시적인 시스템, 조직, 사회적 구조를 효율적으로 운영하고"
                    " 관리하는 것"
                ),
                "M",
            ),
            (
                (
                    "세상이나 생명체, 인간의 근본적인 원리와 본질을 깊이 있게"
                    " 밝혀내는 것"
                ),
                "R",
            ),
    ...
    },
    {
        ...
        "options": [
            ...
            (
                (
                    "자연 현상, 인간의 마음, 언어의 역사, 유전자 등 근본적으로"
                    " 존재하는 대상"
                ),
                "R",
            ),
    ...
    {
        "question": (
            "Q14. 도서관이나 서점에 갔을 때 더 눈길이 가는 책의 종류는?"
        ),
        "options": [
    ...
    {
        "question": (
            "Q15. 성과를 이루었을 때 더 큰 보람을 느끼는 순간은?"
        ),
        "options": [
            (
                "내가 기획하거나 관리한 시스템/조직이 원활하게 잘 돌아갈 때",
                "M",
            ),
            (
                (
                    "아무도 밝혀내지 못한 새로운 사실이나 깊이 있는 원리를"
                    " 깨달았을 때"
                ),
                "R",
            ),
    ...
    },
    {
        ...
        "options": [
            (
                (
                    "글로벌 시장, 국제기구, 공공기관 등 넓은 범주에 영향력을"
                    " 미치는 곳"
                ),
                "G",
            ),
    ...
    },
    {
        ...
        "options": [
            (
                (
                    "인문, 사회, 경제 등 폭넓은 통찰력과 통섭적 시야를 길러주는"
                    " 과목"
                ),
                "G",
            ),
            (
                (
                    "특정 기계, 바이오, 화학, 실무 툴 등 뾰족한 기술과 전문"
                    " 지식을 배우는 과목"
                ),
                "L",
            ),
    ...
    },
    {
        ...
        "options": [
            ...
            (
                (
                    "한 분야의 기술이나 지식을 누구보다 깊게 다루는 '독보적"
                    " 전문성'"
                ),
                "L",
            ),
    ...
    },
    {
        ...
        "options": [
            (
                "불특정 다수의 많은 사람들과 사회 전체에 긍정적 영향력을 줄 때",
                "G",
            ),
            (
                (
                    "눈앞의 구체적인 문제나 기계/제품/기술을 완벽하게"
                    " 해결하고 완성할 때"
                ),
                "L",
            ),
...
if st.session_state.step < total_q:
    st.markdown(
        '<div class="header-sub1">제주대학교 전공체험의 날 - 글로벌자율학부'
        ' 자유전공 체험</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
    ...
    st.markdown(
        '<div class="header-sub2">개인 맞춤형 전공 탐색 및 추천 프로그램 |'
        ' 총 20문항</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        '<hr style="margin: 8px 0 16px 0;">', unsafe_allow_html=True
    )
    ...
    st.markdown(
        f'<div class="question-title">{q_data["question"]}</div>',
        unsafe_allow_html=True,
    )
    st.write("선택지를 골라주세요:")
...
# ------------------------------------
    ...
    st.markdown(
        '<div class="result-sub">🎯 당신의 전공 유형은:</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        f'<div class="result-title">✨ {result_data["title"]} ({mbti})</div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        f'<div class="result-desc-box">{result_data["desc"]}</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        '<div style="font-size: 16px; margin-top: 12px; margin-bottom:'
        f' 8px;">💡 <b>추천 학과</b>: {depts_str}</div>',
        unsafe_allow_html=True,
    )
    ...
    st.caption(
        "⚠️ **본 테스트는 전공 탐색을 위한 참고용으로만 활용해 주시기"
        " 바랍니다.**"
    )
